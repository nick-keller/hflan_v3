    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'choices' => array(
                ...
                'ROLE_DOCUMENT' => 'Ajouter et modifier des documents',
                ...
                'ROLE_REMOVE' => '<i class="fa fa-asterisk"></i> Supprimer des objets SI l\'utilisateur a déjà le droit d\'en créer',
                'ROLE_ADMIN' => '<i class="fa fa-asterisk"></i> Tous les droits précédents + créer des Admin',
            ),
            'multiple' => true,
            'expanded' => true,
            'attr' => array(
